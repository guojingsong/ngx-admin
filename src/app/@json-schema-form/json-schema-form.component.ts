import {
  ...
  forwardRef, Input, Output, OnChanges, OnInit } from '@angular/core';
...
import {
hasValue, inArray, isArray, isEmpty, isNumber, isObject } from './shared/validator.functions';
